...
Shader "Custom/My Transparent Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#endif
			float3 WorldPosition2_g770 = ase_worldPos;
			...
			#endif //aseld
			float dotResult145_g770 = dot( normalizeResult147_g770 , ase_worldlightDir );
			...
			float simplePerlin3D193_g770 = snoise( ( ( WorldPosition2_g770 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
...
/*ASEBEGIN
Version=18103
1927;7;1906;1014;-565.8684;-621.3008;1;True;False
...
ASEEND*/
//CHKSM=1F3EAF2E808985E9656A8E2A5B6FF98C2508A026