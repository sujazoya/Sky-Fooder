	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float3 temp_output_81_0_g770 = (temp_output_4_0).rgb;
				float3 temp_output_2_0_g810 = (AHF_FogColor).rgb;
				float3 gammaToLinear3_g810 = GammaToLinearSpace( temp_output_2_0_g810 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g810 = temp_output_2_0_g810;
				#else
				float3 staticSwitch1_g810 = gammaToLinear3_g810;
				#endif
				float3 temp_output_34_0_g771 = staticSwitch1_g810;
				float3 temp_output_2_0_g811 = (AHF_DirectionalColor).rgb;
				float3 gammaToLinear3_g811 = GammaToLinearSpace( temp_output_2_0_g811 );
				#ifdef UNITY_COLORSPACE_GAMMA
				...
				float3 WorldPosition2_g771 = ase_worldPos;
				float3 normalizeResult147_g771 = normalize( ( WorldPosition2_g771 - _WorldSpaceCameraPos ) );
				float3 worldSpaceLightDir = Unity_SafeNormalize(UnityWorldSpaceLightDir(ase_worldPos));
				float dotResult145_g771 = dot( normalizeResult147_g771 , worldSpaceLightDir );
				half DirectionalMask30_g771 = ( (dotResult145_g771*0.5 + 0.5) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend );
				float3 lerpResult40_g771 = lerp( temp_output_34_0_g771 , staticSwitch1_g811 , DirectionalMask30_g771);
				#if defined(AHF_DIRECTIONALMODE_OFF)
				float3 staticSwitch45_g771 = temp_output_34_0_g771;
				#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g771 = lerpResult40_g771;
				#else
				float3 staticSwitch45_g771 = temp_output_34_0_g771;
				#endif
				float3 temp_output_89_86_g770 = staticSwitch45_g771;
				float temp_output_7_0_g805 = AHF_FogDistanceStart;
				half FogDistanceMask12_g771 = saturate( ( ( distance( WorldPosition2_g771 , _WorldSpaceCameraPos ) - temp_output_7_0_g805 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g805 ) ) );
				...
				half FogHeightMask16_g771 = saturate( ( ( ( break159_g771.x + break159_g771.y + break159_g771.z ) - temp_output_7_0_g806 ) / ( AHF_FogHeightStart - temp_output_7_0_g806 ) ) );
				...
				half NoiseDistanceMask7_g771 = saturate( ( ( distance( WorldPosition2_g771 , _WorldSpaceCameraPos ) - temp_output_7_0_g808 ) / ( 0.0 - temp_output_7_0_g808 ) ) );
				...
				float temp_output_89_87_g770 = temp_output_43_0_g771;
				float3 lerpResult82_g770 = lerp( temp_output_81_0_g770 , temp_output_89_86_g770 , temp_output_89_87_g770);
				#ifdef AHF_ENABLED
				float3 staticSwitch64_g770 = lerpResult82_g770;
				#else
				float3 staticSwitch64_g770 = temp_output_81_0_g770;
				#endif
				float4 appendResult9 = (float4(staticSwitch64_g770 , (temp_output_4_0).a));
...
/*ASEBEGIN
Version=18103
1927;7;1906;1014;358.0973;714.5499;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;13;640,-256;Inherit;False;Apply Height Fog;-1;;770;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;3;FLOAT3;85;FLOAT3;86;FLOAT;87
...
WireConnection;13;81;6;0
WireConnection;7;0;4;0
WireConnection;9;0;13;85
WireConnection;9;3;7;0
WireConnection;1;0;9;0
ASEEND*/
//CHKSM=94E3F3A59A8C4135925279CFAEEFABF507B587EB